  ...
  const projects = [
    {
      ...
      github: "https://github.com/laufjimdev/PersonalWeb",
      demo: "https://laufjimdev.github.io/PersonalWeb/",
    ...
    },
    {
      ...
      date: "Ongoing",
      category: "Startup",
      github: "https://github.com/your-username/healing-app",
      demo: "",
      thumbnail: "/images/placeholder.jpg",
      highlights: [
    ...
    <div className="container pt-8rem pb-5">
      ...
      <div className="text-center mb-5">
        ...
        <p className="text-body mx-auto" style={{ maxWidth: "600px" }}>
          From learning exercises to startup dreams - here's what I've been
          building
        </p>
      </div>
            ...
            <div className="card shadow-sm border-0 rounded-4 glass-effect p-4">
              <div className="row g-4 align-items-stretch">
                ...
                <div className="col-lg-3">
                  <div className="card glass-effect rounded-4 p-3 h-100">
                    {project.thumbnail ? (
                      <img
                      ...
                      <div
                        className="rounded-3 d-flex align-items-center justify-content-center text-body h-100"
                        style={{
                          minHeight: "220px",
                ...
                <div className="col-lg-5">
                  <div className="d-flex justify-content-between align-items-start mb-3">
                    <div>
                      <div className="d-flex align-items-center mb-2">
                        ...
                        <small className="text-lavander">
                          {project.category}
                        </small>
                      </div>

                      <h3 className="h4 fw-bold text-white">
                        {project.title}
                      </h3>
                    </div>
                  ...
                  <div className="d-flex gap-3 flex-wrap">
                    <a
                      ...
                      className="btn btn-brand-dark d-flex align-items-center"
                    >
                      ...
                      {project.highlights.map((highlight, idx) => (
                        <li key={idx} className="text-body d-flex mb-2">
                          <div className="me-2 mt-1">
                            <span className="badge rounded-circle bg-purple">
                              &nbsp;
                            </span>
                          </div>
                          {highlight}
                  ...
                  {project.status === "In Progress" && (
                    <div className="card glass-effect rounded-4 p-3">
                      ...
                      <p className="text-body small">
                        This project is actively being developed. Follow my
                        journey as I build my startup from the ground up!
                      </p>
                    </div>
                  )}
                </div>
